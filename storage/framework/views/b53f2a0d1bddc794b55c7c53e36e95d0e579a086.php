...
<div class="col-md-50  mx-auto bg-ligth ">
    <table class="table">
        <thead class="">
            <tr>
                <th class="text-dark" scole="col"><i style="color: tomato;">Personal registrado</i> </th>
                        ...
                        <?php else: ?>
                            <li class="nav-item dropdown " >
                                <a id="navbarDropdown" class=" dropdown-toggle btn"  href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    <img src="<?php echo e(asset('/img/timeline_black_24dp.svg')); ?>" alt=""> Data
                                </a>
                                ...
                                <div class="dropdown-menu  " style="background-color: #f6f6f6 ;" aria-labelledby="navbarDropdown">
                                    ...
                                    <a href="<?php echo e(route('gestion.escuchas',$operador->legajo)); ?>" class="dropdown-item">Coaching Express</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\sonda\resources\views/gestion/panel.blade.php ENDPATH**/ ?>