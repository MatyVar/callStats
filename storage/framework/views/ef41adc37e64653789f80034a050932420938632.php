             ...
             <!--  <img class="btn" src="img/color-negativo.png" alt="">-->
                <section>
                    ...
                    <div class="content_quiz">
                        <div class="">
                            <section>
                                <a href="localhost/player/plyer.html" target="_blank" onclick="window.open(this.href, this.target, 'width=500,height=250'); return false; " >Abrir reproductor</a>
...
<?php /**PATH C:\Users\User\Desktop\sonda\resources\views/layouts/app.blade.php ENDPATH**/ ?>